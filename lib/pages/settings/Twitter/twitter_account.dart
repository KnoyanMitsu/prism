...
class _TwitterAccountState extends State<TwitterAccount> {
  ...
  void initState() {
    ...
    _storage.getGifEnabled().then((value) {
      setState(() {
        _gifEnabled = value;
      });
    });
    ...
    _controller.init().then((isLoginSuccess) async {
      ...
      if (isLoginSuccess) {
        ...
        final cache =
            await _storage.getCachedUserData(); // PENTING: Pakai 'await'
          ...
          switchCallback: (value) {
            setState(() {
              ...
              if (value) {
                ...
                _storage.disabledGif();
              }
            });
          },
          subtitle: "Enable GIF to make your posts not get generated by AI",
        ),
      ],
    );
  }
